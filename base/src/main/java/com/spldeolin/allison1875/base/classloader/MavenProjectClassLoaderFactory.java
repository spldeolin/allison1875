...
//         Path projectPath = BaseConfig.getInstace()
//             .getProjectPath();
//         try {
//
//             // classes
...
//                 classUrlsCache.add(sourceRoot.getRoot()
//                     .resolve(BaseConfig.getInstace()
//                         .getClassesRelativePath())
//                     .toUri()
//                     .toURL());
//             }
//
...
//                 libUrlsCache.add(Paths.get(lineIterator.next())
//                     .toUri()
//                     .toURL());
//             }
//
