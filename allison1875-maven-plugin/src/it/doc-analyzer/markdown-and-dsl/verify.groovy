...
assert mdFiles[0].name == "订单管理.md" : "Markdown filename should be '订单管理.md'"

// 验证5个 CRUD handler 的文档标题
assert mdContent.contains("查询订单列表") : "Markdown should contain '查询订单列表'"
assert mdContent.contains("支持按状态筛选") : "Markdown should contain sub-description '支持按状态筛选'"
...
assert mdContent.contains("GET /v1/api/orders") : "Markdown should contain 'GET /v1/api/orders'"
assert mdContent.contains("POST /v1/api/orders") : "Markdown should contain 'POST /v1/api/orders'"
assert mdContent.contains("PUT /v1/api/orders/{orderId}") : "Markdown should contain 'PUT /v1/api/orders/{orderId}'"
assert mdContent.contains("DELETE /v1/api/orders/{orderId}") : "Markdown should contain 'DELETE /v1/api/orders/{orderId}'"
