...
@Singleton
@Slf4j
public class JavabeanGeneratorServiceQualifiedTypeImpl implements JavabeanGeneratorService {
    ...
    public JavabeanGeneration generate(JavabeanArg arg) {
        ...
        coid.addAnnotation(AnnotationConstant.DATA_FULL.clone());
        coid.addAnnotation(AnnotationConstant.ACCESSORS_FULL.clone());
        coid.addAnnotation(AnnotationConstant.FIELD_DEFAULTS_PRIVATE_FULL.clone());
