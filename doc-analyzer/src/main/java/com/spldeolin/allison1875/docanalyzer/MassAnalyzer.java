...
//                    if (coid.isInterface()) {
//                        getOrElseDefault(totalInterfaces, sourceRoot, HashMultiset.create()).add(qualifier,
//                        lineCount);
//                    } else {
...
//                (sourceRoot, lineCounts) -> log.info("interface 个数：{} [{}]", lineCounts.entrySet().size(),
//                sourceRoot));
//        totalInterfaces.forEach(
...
//        totalHandlers
//                .forEach((sourceRoot, lineCounts) -> log.info("handler 代码总行数：{} [{}]", lineCounts.size(),
//                sourceRoot));
//
...
//    }
//
//    private static Class<?> tryReflectController(ClassOrInterfaceDeclaration controller) throws
