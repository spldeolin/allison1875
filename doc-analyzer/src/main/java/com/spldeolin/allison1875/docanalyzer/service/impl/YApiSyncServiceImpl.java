...
import com.spldeolin.allison1875.docanalyzer.service.YApiOpenService;
...
public class YApiSyncServiceImpl implements YApiSyncService {
    ...
    @Inject
    private JpdvToStringService jpdvToStringService;

    @Inject
    private EndpointToStringService endpointToStringService;
    ...
    public void outputToYApi(List<EndpointDto> endpoints) throws Exception {
        ...
        for (EndpointDto endpoint : endpoints) {
            ...
            String yapiDesc = endpointToStringService.toString(endpoint);
    ...
    private String toJson(JsonSchema bodyJsonSchema) {
        ...
        JsonSchemaTraverseUtils.traverse(bodyJsonSchema, (propertyName, jsonSchema, parentJsonSchema, depth) -> {
            ...
            if (jpdv != null) {
                jsonSchema.setDescription(jpdvToStringService.toString(jpdv));
            }
        });
        return JsonUtils.toJson(bodyJsonSchema);
    }
    ...
    private Map<String, Long> getYapiCatIdsEachName(Long projectId) {
        List<YApiInterfaceListMenuRespDto> cats = yApiOpenService.listCats(projectId);
    ...
    private Map<String, JsonNode> listAutoInterfaces(Long projectId) {
        JsonNode jsonNode = yApiOpenService.listCatsAsJsonNode(projectId);
    ...
    private void deleteInterface(JsonNode jsonNode, Long recycleBinCatId) {
        ...
        JsonNode respNode = yApiOpenService.getEndpoint(id);
        ...
        JsonNode jsonNode1 = yApiOpenService.updateEndpoint(body);
    ...
    private JsonNode createYApiInterface(String title, String url, String requestBodyJsonSchema,
        ...
        JsonNode responseBody = yApiOpenService.createOrUpdateEndpoint(form);
        return responseBody;
    }
