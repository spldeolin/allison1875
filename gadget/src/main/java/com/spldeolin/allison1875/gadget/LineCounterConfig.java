...
public class LineCounterConfig {
     ...
     */
    @NotNull
    protected Collection<String> typePostfix = Lists.newArrayList();
    ...
    @NotNull
    @PositiveOrZero
    protected Integer displayThreshold = 0;
    ...
    @NotNull
    @PositiveOrZero
    protected Integer dangerThreshold = Integer.MAX_VALUE;
    ...
    @NotNull
    @PositiveOrZero
    protected Integer rankListSize = 10;
